...
#         address = "Andheri road number 2, Mumbai"
#         dispatcher.utter_message("Here the address of the {}:{}".format(facility, address))
#         # dispatcher.utter_message(text="Sure. I'm on it!")
#
#         return [SlotSet("address", address)]

# In this case you do have to include the - slot{} part in your stories.
# Rasa Core will learn to use this information to decide on the correct action to take.
